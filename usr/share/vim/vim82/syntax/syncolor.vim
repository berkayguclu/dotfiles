...
if &background == "dark"
  SynColor Comment	term=bold cterm=NONE ctermfg=240 ctermbg=NONE gui=NONE guifg=#80a0ff guibg=NONE
  SynColor Constant	term=underline cterm=NONE ctermfg=99 ctermbg=NONE gui=NONE guifg=#ffa0a0 guibg=NONE
  SynColor Special	term=bold cterm=NONE ctermfg=LightRed ctermbg=NONE gui=NONE guifg=Orange guibg=NONE
  SynColor Identifier	term=underline cterm=bold ctermfg=14 ctermbg=NONE gui=NONE guifg=#40ffff guibg=NONE
  SynColor Statement	term=bold cterm=NONE ctermfg=40 ctermbg=NONE gui=bold guifg=#ffff60 guibg=NONE
  SynColor PreProc	term=underline cterm=NONE ctermfg=81 ctermbg=NONE gui=NONE guifg=#ff80ff guibg=NONE
  SynColor Type		term=underline cterm=NONE ctermfg=184 ctermbg=NONE gui=bold guifg=#60ff60 guibg=NONE
  SynColor Underlined	term=underline cterm=underline ctermfg=88 gui=underline guifg=#80a0ff
